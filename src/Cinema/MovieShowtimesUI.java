...
//        panel.add(userLoginIDLabel);
        ...
        // Movie Name
        movieNameLabel = new JLabel("<html><h1>Choose Date, Theater,Time and Number of Seat</h1></html>");
        movieNameLabel.setForeground(Color.red);
        movieNameLabel.setBackground(Color.white);
        movieNameLabel.setOpaque(true);
        movieNameLabel.setBounds(200, 30, 550, 50);
...
//                    loadTimesForDate(movieId, dateStr);
    ...
    private void openSeatLayout(int maxSeatsToSelect) {
        ...
        dispose();
        new SeatLayoutManager(selectedMovie, theater, maxSeatsToSelect);
    }
