...
public class RegistationPage extends JFrame implements ActionListener {
    ...
    JButton registerButton, backButton, loginButton;
    ...
    public RegistationPage() {
     ...
     // Back Button
        ...
        messAge = new JLabel("Already have a account ?");
        ...
        loginButton.setBounds(240, 473, 50, 25);
    ...
    private void registerUser() {
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cinema_db", "root", "123");
    ...
    public void actionPerformed(ActionEvent e) {
    	if (e.getSource() == backButton || e.getSource() == loginButton) {
            dispose();
